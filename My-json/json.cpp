...
> Created Time: Wed Sep  6 09:16:55 2023
************************************************************************/
...
Json::Json(const char* value) : m_type(json_string) {
    //new(m_value.m_string) std::string(value);
...
Json::Json(Type type) : m_type(type) {
    switch (m_type) {
        ...
        case json_object: m_value.m_object = new std::map<std::string, Json>(); break;
        default: break;
    }
}
...
bool Json::operator== (const Json& other) {
    ...
    switch (m_type) {
        ...
        case json_int: return m_value.m_int == other.m_value.m_bool;
...
void Json::clear() {
    switch (m_type) {
        ...
        case json_array : {
            ...
            delete m_value.m_array; break;
        }
        case json_object : {   
            for(auto it = (m_value.m_object)->begin(); it != (m_value.m_object)->end(); it++) {
                (it->second).clear();
            }
            delete m_value.m_object; break;
        }
        default: break; 
    }
    m_type = json_null;
...
string Json::str() const {
    ...
    switch (m_type) {
        ...
        break;
        case json_int: ss << m_value.m_int; break;
        case json_double: ss << m_value.m_double; break;
        case json_string: ss << '\"' << *(m_value.m_string) << '\"'; break;
        case json_array: {
            ss << '[';
            for (auto it = (m_value.m_array)->begin(); it != (m_value.m_array)->end(); it++) {
